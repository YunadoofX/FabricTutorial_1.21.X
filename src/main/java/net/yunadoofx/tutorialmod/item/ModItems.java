...
public class ModItems    {
    ...
    public static  final Item RAW_SUPER_AMETHYST = registerItem("raw_super_amethyst", new Item(new Item.Settings()));
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> {
            entries.add(SUPER_AMETHYST);
            entries.add(RAW_SUPER_AMETHYST);
        });
    }
}
